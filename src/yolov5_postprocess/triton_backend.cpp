...
#define RETURN_TRITON_ERROR(CODE, MSG) \
        ...
        bool has_objectness)
    {
        ...
        if (anchors_first)
        {
            ...
            {
                RETURN_TRITON_ERROR(INVALID_ARG, "model_output last dim must equal C = num_classes + (has_objectness ? 5 : 4)");
            }
        ...
        else
        {
            ...
            {
                RETURN_TRITON_ERROR(INVALID_ARG, "model_output channel dim must equal C = num_classes + (has_objectness ? 5 : 4)");
            }
