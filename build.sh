#!/bin/bash
# Build script for Triton custom backends (preprocess, yolo11_postprocess, yolo11_pose_postprocess, yolo11_obb_postprocess, yolov5_postprocess, yolo26_postprocess, rfdetr_postprocess)
